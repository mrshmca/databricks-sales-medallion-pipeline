...
# Databricks Sales Medallion Pipeline

Version 1.0

CI/CD Test - June 2026

The 'sales_medallion_pipeline' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/sales_medallion_pipeline/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] sales_medallion_pipeline_etl` to your workspace.
